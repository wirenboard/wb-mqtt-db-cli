...
# Usage:
# 1) Copy this to somewhere (e.g. ~/.local/share/bash_completion/wb-mqtt-db-cli).
# 2) Add the following line to your .bashrc:
#    source ~/.local/share/bash_completion/wb-mqtt-db-cli
# See also: https://github.com/scop/bash-completion/blob/main/doc/configuration.md



_shtab_wbci_option_strings=(--help -b --broker --from --to --time-format --limit --interval -a --auto-interval --max-records --decimal-places -d --delimiter -o --output-fname --timeout)





_shtab_wbci_pos_0_nargs=+
_shtab_wbci___help_nargs=0
_shtab_wbci__a_nargs=0
_shtab_wbci___auto_interval_nargs=0
...
complete -F _shtab_wbci wb-mqtt-db-cli
